...
var UA = (function () {
  ...
  return {
    ...
    /**
     * Returns true if the user gots a retina display
     *
     * @method isRetina
     */
    isRetina: function () {
      var retinaMediaQuery = '(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)';

      return window.devicePixelRatio > 1 || (window.matchMedia && window.matchMedia(retinaMediaQuery).matches);
    }
